...
var app = (function () {
    ...
    const file$5 = "src/sharedComponents/Nav.svelte";
    ...
    /* src/sharedComponents/Footer.svelte generated by Svelte v3.40.2 */

    const file$4 = "src/sharedComponents/Footer.svelte";
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ navLinks, socialLinks });
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "class", "section-1 svelte-16imr0r");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 25, 0, 792);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
